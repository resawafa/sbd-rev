...
import com.sbd12.sewamobil.Pkg_Jenis_Mobil.JenisMobilTableModel;
...
public class panel_data_barang extends javax.swing.JPanel {
    ...
    public List<JenisMobil> jenis_Mobils ;
    ...
    public void tampilData_jenis() throws ClassNotFoundException
    {

        tabelJenis = new JenisMobilTableModel();
        tabelJenis.setData(jenis_Mobils);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ApplicationContext context = new ClassPathXmlApplicationContext("Config-Spring.xml");
        JenisMobilJDBCTemplate jenisMobilJDBCTemplate = (JenisMobilJDBCTemplate)
                context.getBean("jenisMobilJDBCTemplate");
                jenis_Mobils = jenisMobilJDBCTemplate.listSemua();
